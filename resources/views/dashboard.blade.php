    ...
    <x-card header="Welcome to the TallStackUI Starter Kit">
        <div class="space-y-2">
            ...
            <div class="mt-4 space-y-2">
                <i> "What this starter kit includes out of the box?" </i>
        ...
        <x-slot:footer>
            <span class="text-xs">
                ⚠️
                <x-link href="https://tallstackui.com/docs/v2/starter-kit" bold blank sm
                    >Make sure to read the docs about the starter kit!</x-link
                >
            </span>
        </x-slot:footer>
    </x-card>
